...
!function (jQuery, ytp) {
  jQuery.mbYTPlayer = {
    ...
    addMask: function (a) {
      ...
      return c.CSSAnimate({opacity: 0}, 500, function () {
        c.css({
    ...
    jQuery.fn.unmuteYTPVolume = jQuery.mbYTPlayer.unmute, jQuery.fn.setYTPVolume = jQuery.mbYTPlayer.setVolume, jQuery.fn.setVideoQuality = jQuery.mbYTPlayer.setVideoQuality, jQuery.fn.manageYTPProgress = jQuery.mbYTPlayer.manageProgress, jQuery.fn.YTPGetDataFromFeed = jQuery.mbYTPlayer.getVideoData
